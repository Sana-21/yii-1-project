...
class Comment extends CActiveRecord
{
	...
	/**
	 * Returns a HTML link or encoded author name used in views as `$data->authorLink`.
	 * @return string
	 */
	...
	/**
	 * Returns number of pending comments.
	 * This provides the magic property `pendingCommentCount` used in the sidebar view.
	 * @return integer
	 */
